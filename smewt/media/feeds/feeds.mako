...
refresh_icon = smewtMediaUrl('common', 'images', 'view-refresh.png')
delete_icon = smewtMediaUrl('common', 'images', 'edit-delete.png')
    ...
    <table class="table table-striped table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <div class="btn" onclick="mainWidget.updateFeed('${f['url']}');"><img src="${refresh_icon}" width="24" heigth="24"/></div>
            <div class="btn" onclick="mainWidget.unsubscribeFromFeed('${f['url']}');"><img src="${delete_icon}" width="24" heigth="24"/></div>
          </td>
        </tr>
        %endfor
      </tbody>
