...
setup(name = 'Smewt',
      ...
      package_data = {'smewt.icons': ['*.png', '*.svg'],
                      ...
                      'smewt.media.3rdparty': ['*.js'],
                      'smewt.media.3rdparty.dataTables.media.css': ['*.css'],
                      'smewt.media.3rdparty.dataTables.media.js': ['*.js'],
                      'smewt.media.3rdparty.dataTables.media.images': ['*.jpg'],
